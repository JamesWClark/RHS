SELECT [last name], [first name], [import id], [Personal-Full-Day] + 0.5 * [Personal-Half-Day] AS [Used-Personal], [Sick-Full-Day] + 0.5 * [Sick-Half-Day] AS [Used-Sick], [Vacation-Full-Day] + 0.5 * [Vacation-Half-Day] AS [Used-Vacation], 3 - ([Personal-Full-Day] + 0.5 * [Personal-Half-Day]) AS [Remaining-Personal], 10 - ([Sick-Full-Day] + 0.5 * [Sick-Half-Day]) AS [Remaining-Sick]
FROM (SELECT rhs.[Last Name], rhs.[First Name], rhs.[Import ID], 
